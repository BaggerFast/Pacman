...
class Scene(base.Scene):
    ...
    def __create_highscore_text(self) -> None:
        self.__text_highscore = Text(self.game, f'High score: {self.game.records.data[-1]}' if int(self.game.score) <= self.game.records.data[-1] else f'New record: {self.game.score}', 20)
