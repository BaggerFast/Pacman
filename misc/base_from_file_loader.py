...
class BaseFromFileLoader:
    ...
    def __init__(self, filename: str):
        ...
        self.player_pos: TilePos = TilePos(0, 0)
        self.energizers_pos: List[TilePos] = []
    ...
    def get_energizer_positions(self) -> List[TilePos]: return self.energizers_pos
    def get_player_position(self) -> TilePos: return self.player_pos
    def get_ghosts_positions(self) -> List[TilePos]: return self.ghosts_pos
    def get_fruit_position(self) -> TilePos: return self.fruit_pos
