...
from pacman.misc import LevelLoader, PathManager
from pacman.objects.cheat_codes import Cheat, ControlCheats
from pacman.misc.constants import EvenType, Font, event_append
from pacman.misc.constants.skin_names import SkinsNames
from pacman.objects import *
from pacman.objects.characters import Pacman, Blinky, Pinky, Inky, Clyde
from pacman.objects.characters.ghosts.ghost_states import GhostState
from pacman.objects.fruits import FruitController
from pacman.objects.map import Map
from pacman.objects.score import Score
from pacman.serializers import SettingsSerializer, LevelSerializer
...
class MainScene(scenes.BaseScene):
    ...
    def __load_from_map(self):
        self.__loader = LevelLoader(PathManager.get_asset_path(f'maps/{LevelSerializer().current}.json'))
