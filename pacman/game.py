...
from .misc import LevelLoader, PathManager

from pacman.objects.cheat_codes import Cheat, ControlCheats
from .misc.constants.classes import Sounds, Color
from .misc.constants.skin_names import SkinsNames
from .misc.skins import Skins
from .misc import SoundController
...
class Game:
    ...
    class MapLoader:
        ...
        def __init__(self):
            self.levels: list = PathManager.get_list_path("assets/maps", ext='json')
    ...
    def main_loop(self) -> None:
        ...
        while not self.__game_over:
            ...
            if pg.time.get_ticks() - time >= frequency:
                self.storage_loader.serialize_to_file()
                time = pg.time.get_ticks()
            clock.tick(FPS)
        self.storage_loader.serialize_to_file()
